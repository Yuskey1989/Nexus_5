...
#elif defined(CONFIG_CPU_FREQ_DEFAULT_GOV_INTEREST)
extern struct cpufreq_governor cpufreq_gov_interest;
#define CPUFREQ_DEFAULT_GOVERNOR	(&cpufreq_gov_interest)
#endif
