...
#elif defined(CONFIG_CPU_FREQ_DEFAULT_GOV_ADAPTACTIVE)
extern struct cpufreq_governor cpufreq_gov_adaptactive;
#define CPUFREQ_DEFAULT_GOVERNOR	(&cpufreq_gov_adaptactive)
#endif
